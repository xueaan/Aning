...
export const CodeBlockComponent: React.FC<CodeBlockComponentProps> = ({
  ...
  const currentLanguageLabel = SUPPORTED_LANGUAGES.find(lang => lang.value === currentLanguage)?.label || '无语言';
    ...
    <NodeViewWrapper className="code-block-wrapper">
      ...
      <div className="relative rounded-xl">
        ...
        <div className="relative rounded-xl overflow-hidden">
          ...
          {/* 内容padding容器 */}
          <div className="px-8 py-8 pr-36 pb-10">
            {/* 代码内容滚动容器 */}
            <div className="overflow-x-auto">
              <NodeViewContent 
                className={`hljs font-mono text-sm theme-text-primary min-h-[3rem] whitespace-pre outline-none ${
        ...
        <div className="absolute top-4 right-4 flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-[100]">
          {/* 语言选择�?*/}
          <div className="relative">
            <button onClick={() => setShowLanguageSelect(!showLanguageSelect)}
