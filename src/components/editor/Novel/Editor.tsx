...
const EditorInner = forwardRef<NovelEditorRef, NovelEditorProps>(({
  ...
  return (
    <EditorContent extensions={extensions} initialContent={content as any}
      onUpdate={handleUpdate} onCreate={handleCreate}
...
const NovelEditor = forwardRef<NovelEditorRef, NovelEditorProps>((props, ref) => {
  ...
  return (
    <div className={`editor-container ${editorClasses}`}
