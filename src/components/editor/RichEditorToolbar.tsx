    ...
    <div
      className={cn(
        ...
        !className?.includes('bg-transparent') && [
          'rounded-lg',
          'theme-bg-secondary/95 backdrop-filter backdrop-blur-sm',
          'theme-border/20 shadow-lg shadow-black/10 dark:shadow-black/30',
        ],
        'w-full max-w-full',
        className
      )}
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    active && ['theme-bg-accent/20 theme-text-accent', 'theme-border/30'],
