              ...
              >
                ...
                <div className="space-y-1">
                  {day.tasks.slice(0, 3).map((task) => (
                    <div key={task.id} className="flex items-center gap-1" title={task.title}>
                  ...
                  {day.tasks.length > 3 && (
                    <div className="text-xs text-text-tertiary">{day.tasks.length - 3} 更多</div>
                  )}
                </div>
                {/* 快速添加按钮 */}
          ...
          <div className="flex-1 p-4 space-y-3 overflow-y-auto">
            {selectedDayTasks.length === 0 && showQuickAdd !== selectedDate ? (
              <div className="flex flex-col items-center justify-center py-8 text-text-tertiary">
                ...
                <button
                  onClick={() => setShowQuickAdd(selectedDate)}
