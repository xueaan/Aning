  ...
  if (tasks.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-64 text-center">
        <div className="theme-text-tertiary mb-4">{emptyIcon}</div>
        <h3 className="text-lg font-medium theme-text-secondary mb-2">{emptyMessage}</h3>
      </div>
    );
  }
      ...
      {showFilters && (
        <div className="flex items-center gap-4 p-3 rounded-lg feather-glass-deco">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <option value="all" className="theme-bg-primary theme-text-primary">
                全部状态
              </option>
              <option value="todo" className="theme-bg-primary theme-text-primary">
                待办
              </option>
              <option value="in_progress" className="theme-bg-primary theme-text-primary">
                进行中
              </option>
              <option value="completed" className="theme-bg-primary theme-text-primary">
                已完成
              </option>
              <option value="cancelled" className="theme-bg-primary theme-text-primary">
                已取消
              </option>
            </select>
          </div>
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <option value="urgent" className="theme-bg-primary theme-text-primary">
                紧急
              </option>
              <option value="high" className="theme-bg-primary theme-text-primary">
                高
              </option>
              <option value="medium" className="theme-bg-primary theme-text-primary">
                中
              </option>
              <option value="low" className="theme-bg-primary theme-text-primary">
                低
              </option>
            </select>
          </div>
          ...
          return (
            <div key={groupKey} className="space-y-3">
              ...
              {(groupByStatus || groupByDate) && (
                <div
                  className={`flex items-center gap-2 text-sm font-medium ${group.color || 'theme-text-primary'}`}
                >
                  {group.icon}
              ...
              {/* 任务列表 */}
              <div
                className={compact ? 'bg-transparent rounded-lg border-transparent' : 'space-y-2'}
              >
                {compact && showProject && (
                  // Compact模式的表头
