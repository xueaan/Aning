...
export const DateCell: React.FC<DateCellProps> = ({
  ...
  const getCellClassName = () => {
    let baseClass = "w-5 h-5 flex items-center justify-center text-xs rounded transition-all duration-200 cursor-pointer font-medium";
  ...
  return (
    <button onClick={onClick} disabled={isDisabled}
            ...
            className={getCellClassName()} title={date.dateString}
    >
      {date.day}
    </button>
  );
