...
export const TaskDistribution: React.FC = () => {
  ...
  return (
    <div className="rounded-xl p-4 md: p-6">
      <h3 className="text-lg font-semibold theme-text-primary mb-4 md:mb-6">任务分布统计</h3>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
        {/* Task Status Distribution */}
        <div>
          <h4 className="text-sm font-medium theme-text-secondary mb-4">按状态分布</h4>
              ...
              return (
                <div key={item.status} className="flex items-center justify-between">
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    />
                    <span className="text-sm theme-text-secondary min-w-16">{item.label}</span>
                  ...
                  <div className="text-right ml-4">
                    ...
                    <span className="text-xs theme-text-tertiary ml-1">({percentage}%)</span>
                  </div>
                </div>
              );
            })}
        ...
        <div>
          <h4 className="text-sm font-medium theme-text-secondary mb-4">按优先级分布</h4>
          <div className="space-y-3">
              ...
              return (
                <div key={item.priority} className="flex items-center justify-between">
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    <span className="text-sm theme-text-secondary min-w-20">{item.label}</span>
                    <div className="flex-1 theme-bg-tertiary rounded-full h-2">
                      <div
                        className={`h-2 rounded-full ${item.color} transition-all duration-300`}
                        style={{ width: `${percentage}%` }}
