      ...
      {(showAddForm || isEditing) && (
        <div className="p-4 rounded-xl feather-glass-deco">
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-sm theme-text-tertiary">点击选择图标</div>
                </div>
                <IconPicker
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm theme-text-accent theme-bg-accent/20 px-2 py-1 rounded">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={isEditing ? saveEdit : addNewAgent}
                disabled={!formData.name.trim()}
                className={`px-4 py-2 text-sm rounded-lg flex items-center gap-2 theme-text-accent transition-colors ${
                  !formData.name.trim()
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="text-sm font-medium theme-text-primary truncate">
                      {agent.name}
                    </h3>
              ...
              <div className="flex items-center gap-2">
                {aiConfig.currentAgentId !== agent.id && (
                  <button
                    onClick={() => handleSetCurrent(agent.id)}
                    className="px-2 py-1 text-xs bg-white/10 hover:bg-white/20 text-accent rounded transition-colors"
                  >
                    使用
                  </button>
                )}
                <button
                  ...
                  className="p-1.5 rounded theme-text-secondary hover:theme-text-primary"
                  title="编辑"
                >
                  <Edit3 size={16} />
                </button>
