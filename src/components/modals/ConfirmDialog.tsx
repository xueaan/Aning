...
export const ConfirmDialog: React.FC = () => {
  const { isOpen, title, message, confirmText, cancelText, type, confirm, cancel } =
    useDialogStore();
      ...
      case 'warning':
        return (
          <AlertTriangle
            ...
            style={{ color: 'rgba(var(--status-warning), 1)' }}
          />
        );
      case 'danger':
        return (
          <X
            ...
            style={{ color: 'rgba(var(--status-error), 1)' }}
          />
        );
      case 'success':
        return (
          <Check
            ...
            style={{ color: 'rgba(var(--status-success), 1)' }}
          />
        );
      default:
        return (
          <Info
            ...
            style={{ color: 'rgba(var(--status-info), 1)' }}
          />
        );
    }
  };
  ...
  return (
    ...
    >
      ...
      {/* 对话框 */}
      <div
        className={`relative max-w-md w-full rounded-xl shadow-2xl animate-scaleIn feather-glass-content border border-border-primary/50`}
      ...
      >
        ...
        <div className="flex justify-end gap-3 p-4 border-t border-border-primary">
          ...
          <button onClick={confirm} className={getConfirmButtonClass()} autoFocus>
            {confirmText}
          </button>
        </div>
      </div>
